...
public class Fibonacci {
  ...
  public void extendBy(int howManyMore) {
    ...
    int[] extendedSequence = new int[currentLength + howManyMore];
    System.arraycopy(sequence, 0, extendedSequence, 0, currentLength);

    for (int i = currentLength; i < extendedSequence.length; i++) {
  ...
  public String fibonacciString() {
    return ArrayPrinter.printArray(sequence);
  }
}
